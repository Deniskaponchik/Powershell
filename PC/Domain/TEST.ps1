...
Add-LocalGroupMember -Group 'Пользователи удаленного рабочего стола' -Member ('Администраторы') –Verbose
...
# Messages:
"`n"
Write-Host "Брандмауэр выключен, Уд. рабочий стол включен, Порт VMI открыт, имя ПК изменено на: $NamePC" -ForegroundColor Green
