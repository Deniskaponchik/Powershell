...
# $pass = Get-ADUser -identity $ResultUL -properties *
# if($s -eq 0){$ResultUL = Get-ADUser -identity $u -properties *}
# else {$ResultUL= Get-ADUser -filter { (displayname -like $u) -and (userAccountControl -eq "512")} -properties *}
