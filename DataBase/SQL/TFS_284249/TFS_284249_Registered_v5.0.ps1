...
#$dataSource = “server\instance”
#$dataSource = "t2ru-tr-tst-02"
$database = Read-Host "База данных (по умолчанию BPMonline_80 )"
 if ($database -eq '') {
...
$FileSqlTxt = Get-Content "D:\Scripts\PowerShell\SQL\TFS_284249_Closed_v5.0.sql" -Encoding UTF8 -Raw
$CsvPath = "D:\Scripts\PowerShell\SQL\TFS_284249_Closed_v5.0"
