...
$FileSqlTxt = Get-Content "D:\Scripts\PowerShell\SQL\TFS_284249_Registered_v2.6_PS.sql" -Encoding UTF8 -Raw
               $CsvPath = "D:\Scripts\PowerShell\SQL\TFS_284249_Registered_v2.6_PS"
