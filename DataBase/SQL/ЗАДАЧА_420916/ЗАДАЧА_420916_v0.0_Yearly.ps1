...
$FileSqlTxt = Get-Content "D:\Scripts\PowerShell\SQL\ЗАДАЧА_420916_v0.0_Yearly.sql" -Encoding UTF8 -Raw
$CsvPath = "D:\Scripts\PowerShell\SQL\ЗАДАЧА_420916_v0.0_Yearly"

$Query = @"
$FileSqlTxt
"@
$dataSource = "t2ru-bpmdb-read\bpmonline"       # t2ru-bpmdb-read\bpmonline t2ru-tr-tst-02
$database = "BPMonline7"                        # "BPMonline7_8888"
